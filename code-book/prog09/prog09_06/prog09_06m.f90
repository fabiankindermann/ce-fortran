...
module globals
    ...
    real*8 :: E_c, E_i, E_k, E_l, E_r, E_w, E_y, E_V
    real*8 :: CV_c, CV_i, CV_k, CV_l, CV_leis, CV_r, CV_w, CV_y
    real*8 :: Cor_c, Cor_i, Cor_k, Cor_l, Cor_leis, Cor_r, Cor_w
