...
! PROGRAM SOLG_TR_2
!
! ## The stochastic OLG model with progressive taxation
!
...
program SOLG_TR_2
    ...
    tax(1:TT) = 5
    tauw(1:TT) = 0.15d0
    taur(1:TT) = taur(0)   ! (use this for optimal progressivity only)
    !taur(1:TT) = 0.20d0    ! (uncomment this for optimal capital income tax)
