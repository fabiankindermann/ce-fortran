!##############################################################################
! PROGRAM FemaleParticipationUcost
!
! ## Female labor force participation with utility cost (Attanasio et al.,2008)
!
                                ...
                                do ism_p = 1, NS
                                    do isf_p = 1, NS
                                        ...
                                        RHS(ia, ih, ip, ism, isf, il) = RHS(ia, ih, ip, ism, isf, il) + &
                                                pi(ism, ism_p)*pi(isf, isf_p)*margu(chelp, il, ij)
