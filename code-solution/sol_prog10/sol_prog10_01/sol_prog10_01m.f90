...
module globals
    ...
    real*8, parameter :: sigma_white = 0.057d0

    ! numerical parameters
    real*8, parameter :: a_l    = 0d0
    real*8, parameter :: a_u    = 1000d0
    ...
    real*8 :: a(0:NA), aplus(JJ, 0:NA, NP, NS, NW), c(JJ, 0:NA, NP, NS, NW)
    real*8 :: phi(JJ, 0:NA, NP, NS, NW), V(JJ, 0:NA, NP, NS, NW) = 0d0
    ...
    integer :: ij_com, ia_com, ip_com, is_com, iw_com
    real*8 :: cons_com
