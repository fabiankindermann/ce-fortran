...
module globals
    ...
    ! replacement rate of female pensions
    real*8, parameter :: chi = 0.0d0
    ...
    ! transfer payments (old-age) and survival probabilities, productivity
    real*8 :: pen_m(JJ), pen_f(JJ, 0:NH), psi(JJ+1), eff(JJ)
...
contains
    ...
    function foc(x_in)
        ...
        cons_com = (1d0+r)*a(ia_com) + pen_m(ij_com) + pen_f(ij_com, ih_com) + wage_f + wage_m - a_plus
