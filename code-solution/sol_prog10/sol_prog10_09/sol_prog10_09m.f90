...
module globals
    ...
    real*8 :: c_coh(JJ), n_coh(JJ), l_coh(JJ), h_coh(JJ), a_coh(JJ), v_coh(JJ)
    real*8 :: cv_c(JJ), cv_n(JJ), cv_l(JJ), cv_h(JJ), corr_hn(JJ)
...
contains
    ...
    function foc(x_in)
        ...
        real*8 :: foc, cons, varphi, tomorrow, wage
        integer :: ial, iar
        ...
        ! get labor supply
        lab_com = max((wage/nu)**chi*max(cons, 1d-10)**(-chi/gamma), 0d0)

        ! calculate tomorrows assets
        a_plus_com = (1d0+r)*a(ia_com) + pen(ij_com) + wage*lab_com - cons
    ...
    function foc_liq(x_in)
        ...
        ! calculate first order condition for consumption
        foc_liq = (1d0+r)*a(ia_com) + pen(ij_com) + wage*lab_com - cons
    ...
    ! calculates the labor value function
