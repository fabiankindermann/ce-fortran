!##############################################################################
! PROGRAM LaborSupplySeparable
!
! ## Endogenous Labor Supply with additively separable preferences
!
                ...
                do is = 1, is_max
                    do ia = 0, NA
                        ...
                        if(ij >= JR)then
                            ...
                            l_endo(ia) = (wage/nu)**chi*c_endo(ia)**(-chi/gamma)
                        endif
                        a_endo(ia) = (c_endo(ia) + a(ia) - pen(ij) - wage*l_endo(ia))/(1d0+r)
                    enddo
                    ...
                    do ia = 0, NA
                        ...
                        if(a(ia) <= a_endo(0))then
                            ...
                            if(ij >= JR)then
                                ...
                                ! solve FOC under borrowing constriant
                                ij_com = ij
                                ia_com = ia
                                ip_com = ip
                                is_com = is
                            ...
                            aplus(ij, ia, ip, is) = (1d0+r)*a(ia) + wage*l(ij, ia, ip, is) + pen(ij) &
                                                    - c(ij, ia, ip, is)
